# Name: Arash-Tajalli
# Prog Purpose: Uses lists to find the personal property tax for vehicles in Charlottesille
#    and producs a report which displays all data and the total tax due.
#
...
#       -- Eligibility: Owned or leased vehicles which are predominately used for non-business purposes and 
#       -- have passenger license plates
